...
const About = () => {
    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 grid-rows-1 md:grid-cols-4 md:gap-x-10 md:items-center">
                <div className="col-start-1 col-span-1 hidden md:block">
                    <img src={"/images/liam.png"} width={250} height={250} className="rounded-full -mt-5 pb-10"/>
                </div>
                <div className="md:col-start-2 md:col-span-3">
                    ...
                    <p>
                        Aside from programming I'm reallo into sports. I've been playing hockey since
